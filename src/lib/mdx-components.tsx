...
export const mdxComponents: MDXComponents = {
  ...
  p: (props) => (
    <p className="mt-4 leading-8 text-[color:var(--muted)]" {...props} />
  ),
  ul: (props) => (
    <ul
      className="mt-4 list-disc space-y-2 pl-6 text-[color:var(--muted)]"
      {...props}
    />
  ),
  ol: (props) => (
    <ol
      className="mt-4 list-decimal space-y-2 pl-6 text-[color:var(--muted)]"
      {...props}
    />
  ),
  ...
  blockquote: (props) => (
    <blockquote
      className="mt-6 border-l-4 border-[var(--accent)] pl-4 italic text-[color:var(--muted)]"
      {...props}
    />
  ),
  code: (props) => (
    <code
      className="rounded bg-[color:var(--accent-soft)] px-1.5 py-0.5 font-mono text-sm text-[color:var(--accent-strong)]"
      {...props}
    />
  ),
  pre: (props) => (
